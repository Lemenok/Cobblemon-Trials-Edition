...
public class ModProcessors {
    ...
    public static final DeferredHolder<StructureProcessorType<?>, StructureProcessorType<SpawnerReplacementProcessor>> SPAWNER_REPLACEMENT_PROCESSOR =
        STRUCTURE_PROCESSORS.register("spawner_replacement_processor", () -> () -> SpawnerReplacementProcessor.CODEC);
