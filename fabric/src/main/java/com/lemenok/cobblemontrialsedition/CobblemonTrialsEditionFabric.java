...
@Mod(CobblemonTrialsEditionFabric.MODID)
public class CobblemonTrialsEditionFabric {
    ...
    public CobblemonTrialsEditionFabric(IEventBus modEventBus, ModContainer modContainer) {
    ...
    public static class ClientModEvents {
        ...
        public static final ResourceKey<Registry<StructureProperties>> COBBLEMON_TRIALS_STRUCTURE_REGISTRY =
                ResourceKey.createRegistryKey(
                        ResourceLocation.fromNamespaceAndPath(CobblemonTrialsEditionFabric.MODID, "structures")
                );

        public static final ResourceKey<Registry<StructureProperties>> COBBLEMON_TRIALS_DEFAULT_STRUCTURE_REGISTRY =
                ResourceKey.createRegistryKey(
                        ResourceLocation.fromNamespaceAndPath(CobblemonTrialsEditionFabric.MODID, "default")
                );

        public static final ResourceKey<Registry<LootTable>> COBBLEMON_TRIALS_LOOT_TABLE_REGISTRY =
                ResourceKey.createRegistryKey(
                        ResourceLocation.fromNamespaceAndPath(CobblemonTrialsEditionFabric.MODID, "loot_table")
                );
